...
```{r render_pdf_as_image, error=FALSE, echo=FALSE}
# Load required libraries
library(pdftools)
library(magick)
library(knitr)
...
```{r setup, error=FALSE, echo=FALSE, message=FALSE, warning=FALSE, results='hide'}
...
```{r, error=FALSE, echo=FALSE, message=FALSE, warning=FALSE, out.width='100%'}
